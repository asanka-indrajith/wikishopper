	...
	public void onCreate(Bundle savedInstanceState) {
      ...
      productSearch.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View v) {
				Intent i=new Intent(getApplicationContext(),ProductSearchAppActivity.class);                  // display Search interface
				startActivity(i);
			}
		});
      Category.setOnClickListener(new OnClickListener() {			
			@Override
			public void onClick(View v) {
				Intent i=new Intent(getApplicationContext(),HomePage.class);                                  // display category references interface.  
				startActivity(i);
			}
		});
