...
public class ProductDetailsList extends Activity {
	  ...
	  private GenericSeeker<Product> relatedsearch = new RelatedProductSeeker();
	    ...
	    mainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { 
	         ...
	         String[] menuNames = new String[] { "PRODUCT COLLABORATIVE REVIEW - PROS", "PRODUCT COLLABORATIVE REVIEW - CONS", "DESCRIPTION","KEY FEATURES" ,"PRODUCT IMAGE", "MORE NFORMATION","RELATED PRODUCTS"};  
	...
	public void displayProductOption(int position){
		if(position==0){
			Intent intent = new Intent(ProductDetailsList.this, ProductProsList.class);
			...
			Intent intent = new Intent(ProductDetailsList.this, ProductConssList.class);
			...
			Intent intent = new Intent(ProductDetailsList.this, ProductDescription.class);
			...
			Intent intent = new Intent(ProductDetailsList.this, KeyFeaturesList.class);
			...
			Intent intent = new Intent(ProductDetailsList.this, ProductWebView.class);
			...
			progressDialog = ProgressDialog.show(ProductDetailsList.this,
            		"Please wait...", "Searching  Related products...", true, true);
		...
		protected void onPostExecute(final ArrayList<Product> result) {	    //present the results by calling a another activity.		
			runOnUiThread(new Runnable() {
		    	...
		    	public void run() {
		    		...
		    		Intent intent = new Intent(ProductDetailsList.this, ProductRelatedListActivity.class);
