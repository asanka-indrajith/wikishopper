...
public class ProductByNameSeeker extends GenericSeeker<Product> {
	...
	private String url2 = ":&format=xml&key=2358feba734043a9b2f6c52520f5feb5&fields=key_features";
	...
	@Override
	public ArrayList<Product> find(String query) { // perform search without
													// limitation.
	...
	@Override
	public ArrayList<Product> find(String query, int maxResults) { // limiting
																	// maximum
																	// numbers
																	// of
																	// results
