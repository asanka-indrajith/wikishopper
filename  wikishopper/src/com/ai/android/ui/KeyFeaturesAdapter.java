...
public class KeyFeaturesAdapter extends ArrayAdapter<String> {
	...
	public KeyFeaturesAdapter(Activity context, int textViewResourceId,
		...
		if (feature != null) {
			...
			TextView titleTextView = (TextView) view
					.findViewById(R.id.feature_text_view); // Take reference of
															// each of the views
															// widgets
			titleTextView.setText("Feature: " + values[0]); // providing the
															// relevant text,

			// values
			TextView categoryTextView = (TextView) view
					.findViewById(R.id.value_text_view);
